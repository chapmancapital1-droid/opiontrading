...
KEYWORD_MAP: List[Tuple[str, str, List[str], List[str]]] = [
    ...
    ("covered write", "Trading Strategies", ["income"], ["covered_call", "saliba_ch1"]),
    ("covered-write", "Trading Strategies", ["income"], ["covered_call", "saliba_ch1"]),
    ("vertical spread", "Trading Strategies", ["spreads"], ["bull_put", "bear_call", "saliba_ch2"]),
    ("bull put", "Trading Strategies", ["spreads"], ["credit_spread", "bull_put", "saliba_ch2"]),
    ("bear call", "Trading Strategies", ["spreads"], ["credit_spread", "bear_call", "saliba_ch2"]),
    ("collar", "Trading Strategies", ["hedging"], ["protective_put", "collar", "saliba_ch3"]),
    ("reverse collar", "Trading Strategies", ["hedging"], ["collar", "saliba_ch3"]),
    ("iron butterfly", "Trading Strategies", ["defined_risk"], ["iron_butterfly", "saliba_ch5"]),
    ("condor", "Trading Strategies", ["defined_risk"], ["iron_condor", "saliba_ch5"]),
    ("ratio spread", "Trading Strategies", ["advanced"], ["ratio", "saliba_ch7"]),
    ("backspread", "Trading Strategies", ["advanced"], ["backspread", "saliba_ch8"]),
    ("saliba", "Source References", ["saliba_2009"], ["vertical", "condor", "calendar"]),
    ("option spread strategies", "Source References", ["saliba_2009"], ["spreads"]),
